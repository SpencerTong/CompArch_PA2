...
formats = {'first':'file', 'second':'file', 'third':'file', 'fourth':'file', 'fifth':'file', 'sixth':'file', 'seventh':'data', 'eighth':'data', 'ninth':'data', 'tenth':'data'}

weight = {'first':0.5, 'second':0.5, 'third':1.5,  'fourth':0.75, 'fifth':2.0, 'sixth': 2.0, 'seventh': 0.625, 'eighth':0.75, 'ninth':1.0, 'tenth':0.75}

scores = {'first':0, 'second':0, 'third':0, 'fourth':0, 'fifth':0, 'sixth':0, 'seventh':0, 'eighth':0, 'ninth':0, 'tenth':0}
...
def global_grade(dirname):
	...
	#print "looking now for -", os.path.join(subdir), "-"
        ...
        if subdir in formats and formats[subdir]=='line':
            ...
            file_grade(subdir)
        elif subdir in formats and formats[subdir]=='data':
            data_grade(subdir)
